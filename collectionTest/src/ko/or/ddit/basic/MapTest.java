...
public class MapTest {
	public static void main(String[] args) {
		...
		/*
		 * Map >> key값과 value값을 한쌍으로 관리하는 객체 Key값은 중복을 허용하지 않고 순서가 없다. value값은 중복을 허용한다.
		 * 
		 */
...
//		System.out.println("sTemp >> " + sTemp);
		...
		// 방법1) 모든 key값을 가져와서 처리하기 (2가지 방법이 있음)
		// 방법 1-1) keySet()메소드는 Map에 있는 모든 Key값을 읽어와 Set형으로 반환하는 메소드
		//           keySet()정보를 iterator방법으로 처리하기
		...
		System.out.println("-----------------------------------------------------");
		// 방법 1-2) keySet()정보를 'foreach'문으로 사용
		...
		// 방법2) value값만 가져오 ㅏ처리하기 >> values() 메소드 사용
