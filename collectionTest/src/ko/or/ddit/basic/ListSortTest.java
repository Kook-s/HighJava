 ...
 *  
 *  Comparable은 Collection에 추가 되는 데이터 자체에 정쳘 기준을 넣고 싶을 때 구현하는 
 *  인터페이스이다. (내부 정렬 가준을 작성할 때 사용)
 *  
 ...
 *   
 *   String 클래스, Wrapper클래스들, Date클래스, File클래스에는 내부 정렬 기준이 구현되어 있다.
...
class Desc implements Comparator<String> {
	...
	// 예) 오름차순일 경우 ==> 앞의 값이 크면 양수 , 같으면 0 , 앞의 값이 작으면 음수를 반환하도록 구현한다.
