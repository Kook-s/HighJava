...
public class PropertiesTest {
	...
	/*
	 * Properties객체는 Map보다 축소된 기능의 객첼하고 할 수 없다.
	 * 
	 * Map은 key값과 value값에 모든 종류의 객체를 사용할 수 있지만 Properties객체는 key와 value에 String만 사용할
	 * 수 있다.
	 * 
	 * Map put(), get()메소드를 이용하여 데이터를 입출력하지만 Properties객체는 setProperty(),
	 * getProperty()메소드를 사용하여 입출력한다.
	 * 
