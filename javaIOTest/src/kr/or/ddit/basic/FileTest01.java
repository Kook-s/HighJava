...
//File객체 만들기 연습
		...
		// >>디렉토리와 디렉토리 사이 또는 디렉톨리와 파일 명 사이의
		// 구분자 '\'를 사용하거나 '/'를 사용할 수 있다.

//		File file = new File("d:/d_other/test.txt"); // 구분문자를 '/'로 사용한 경우
		...
		// 2. new File(Filr parent, String child);
		 ...
		 *  
		 * -mkdirs() >> 중간 부분의 경로가 없으면 중간부분의 경로도 만들어진다.
		 */
