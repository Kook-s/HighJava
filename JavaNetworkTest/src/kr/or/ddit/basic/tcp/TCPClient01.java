...
public class TCPClient01 {
	public static void main(String[] args) throws UnknownHostException, IOException {
		/*
		 * 현재의 컴퓨터를 나타내는 방법 1. 원래의 IP주소 : 예) 192.168.146.70 2. 지정된 IP주소 : 127.0.0.1 //어떤
		 * 컴퓨터에서든 이걸 사용사면 내껄 의미한다 3. 원래 컴퓨터의 이름 : 예 ) DESKTOP-1J4B3U9 4. 지정된 컴퓨터 이름 :
		 * localhost
		 */
...
//		Socket socket = new Socket("상대방의 IP주소",상대방의 Port번호);
		...
		// Socket의 InputStream객체를 구해서 데이터를 수신한다.
