...
/*
 * 1~20억까지의 합계를 구하는 프로그램을 하나의 쓰레드가 처리도리때와
...
public class ThreadTest04 {
	...
	public static void main(String[] args) {
		...
		System.out.println("단독으로 처리 했을 때 경과 시간 : " + (endTime - startTime));
		System.out.println();
		...
		System.out.println("여러개의 쓰레드가 협력해서 처리 했을 때 경과 시간 : " + (endTime - startTime));
	}
}
