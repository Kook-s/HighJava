 ...
 * 이 때 사용하던 자우너을 정리하지 못하고 쓰레드가 종료되어
 * 다른 쓰레드에 영향을 줄 수 있다.
...
public class ThreadTest11 {
	public static void main(String[] args) {
		/*
		 * ThreadStopTest1 th1 = new ThreadStopTest1(); th1.start();
		 * 
...
//			// 검사방법1 >> Thread의 인스턴스 메서드인 isInterrupted()메소드 이용하기
//			// -isInterrupted()메서드>> intereupt()메서드가 호출 되면 true를 반환
//			if (this.isInterrupted()) {
//				break;
//			}
			// 검사방법1 >> Thread의 정적(static) 메서드인 isInterrupted()메소드 이용하기
			// -isInterrupted()메서드>> intereupt()메서드가 호출 되면 true를 반환
